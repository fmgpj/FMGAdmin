...
import { defaultDepartmentValues } from "@/src/lib/forms/department/department-form-default-values";
...
import { DepartmentFormFields } from "@/src/lib/forms/department/department-form-field";
...
const DepartmentForm = ({
    ...
    const defaultValues: FormData = useMemo(
        () => defaultDepartmentValues(initialValues),
        [initialValues]
    );
            ...
            >
                <div className="w-full bg-white p-4 rounded-lg shadow-md flex flex-col overflow-y-auto max-h-screen min-h-125">
                    <FormProvider {...methods}>
                        <FormBuilder fields={DepartmentFormFields} isReadOnly={isReadOnly} />
                    </FormProvider>
                </div>
